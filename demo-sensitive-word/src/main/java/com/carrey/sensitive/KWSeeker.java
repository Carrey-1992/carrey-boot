...
import com.carrey.sensitive.processor.*;
import com.carrey.sensitive.util.AnalysisUtil;
import com.carrey.sensitive.util.EmojiUtil;
...
public class KWSeeker {
     ...
     * 关键词树
     */
    private Map<String, Object> wordsTree = new ConcurrentHashMap<>();
    ...
    private static class DataInit {
         ...
         */
        private Map<String, Object> wordsTreeTmp = new HashMap<>();
         ...
         */
        public int generalTree(Set<KeyWord> sensitiveWords, Map<String, Object> wordsTree) {
            ...
            for (KeyWord kw : sensitiveWords) {
                ...
                AnalysisUtil.makeTreeByWord(wordsTreeTmp, kw.getCharacters());
            }
            wordsTree.clear();
